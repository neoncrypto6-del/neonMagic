...
{
  name: 'MetaMask',
  logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/MetaMask_Fox.svg/3840px-MetaMask_Fox.svg.png'
},
{
  name: 'Trust Wallet',
...
{
  name: 'Crypto.com',
  logo: "/crypto.com-logo.png"
},
{
  name: 'Ledger',
  logo: 'https://cryptorecovers.com/wp-content/uploads/2025/03/Ledger.png'
},
{ name: 'Phantom', logo: 'https://docs.phantom.com/favicon.svg' },
{
  name: 'Coinbase',
  logo: "/Coinbase.png"
},
